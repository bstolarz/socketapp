...
t_valor_variable AnSISOP_dereferenciar(t_puntero direccion_variable){
	...
	void* readResult = memory_request_read(serverMemory, pcb->pid, pos.page, pos.off, VAR_SIZE);
...
void AnSISOP_asignar (t_puntero direccion_variable, t_valor_variable valor){
	...
	int writeResult = memory_request_write(serverMemory, pcb->pid, pos.page, pos.off, VAR_SIZE, &valor);
